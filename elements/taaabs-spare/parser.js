...
parserCLN = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        for(var i in s)
        {
          if(i == 0 && concat_all_request( s, i)) { resultats += "{"; } 
          else if( concat_all_request( s, i) ) { 
            resultats += "union {";
          }
          if( concat_all_request( s, i) )
        ...
        //peg$c63 = function(obj) { id_obj++; return ["SELECT (COUNT ( distinct ?sobs"+ old_id_obj +" ) AS ?num_sobs"+ old_id_obj + ") \nWHERE \n "+ obj[0], obj[1] ];},
